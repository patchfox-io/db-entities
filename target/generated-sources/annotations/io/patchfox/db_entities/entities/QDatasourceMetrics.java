...
/**
 * QDatasourceMetrics is a Querydsl query type for DatasourceMetrics
 */
@Generated("com.querydsl.codegen.DefaultEntitySerializer")
public class QDatasourceMetrics extends EntityPathBase<DatasourceMetrics> {

    private static final long serialVersionUID = 723747388L;

    public static final QDatasourceMetrics datasourceMetrics = new QDatasourceMetrics("datasourceMetrics");
    ...
    public QDatasourceMetrics(String variable) {
        super(DatasourceMetrics.class, forVariable(variable));
    }

    public QDatasourceMetrics(Path<? extends DatasourceMetrics> path) {
        super(path.getType(), path.getMetadata());
    }

    public QDatasourceMetrics(PathMetadata metadata) {
        super(DatasourceMetrics.class, metadata);
    }
